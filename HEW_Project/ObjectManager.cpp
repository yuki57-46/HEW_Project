...

{
	...
	Setting data[] = {
		...
		//==========stage1====================
		//{1.25f, 0.0f, 2.5f, 0.25f, 0.5f, 0.25f,true,false},
		//{0.5f, 0.0f, 2.5f, 0.25f, 0.25f, 0.25f,true,false},
		//{0.25f, 0.0f, 2.5f, 0.25f, 0.25f, 0.25f,true,false},
		//{0.25f, 0.25f, 2.5f, 0.25f, 0.25f, 0.25f,true,false},
		//{0.0f, 0.0f, 2.5f, 0.25f, 0.25f, 0.25f,true,false},
		//{-0.25f, 0.0f, 2.5f, 0.25f, 0.5f, 0.25f,true,false},
		//{-0.25f, 0.5f, 2.5f, 0.25f, 0.25f, 0.25f,true,false},
		//{-0.25f, 0.0f, 3.5f, 0.25f, 0.25f, 0.25f,true,false},
		//{-1.0f, 0.0f, 2.5f, 0.25f, 0.25f, 0.25f,true,false},
		//{-1.5f, 0.0f, 2.5f, 0.25f, 0.25f, 0.25f,true,false},
		//{-1.5f, 0.25f, 2.5f, 0.25f, 0.5f, 0.25f,true,false},

		//===========stage2====================
		//{1.0f, 0.0f, 0.0f, 0.25f, 0.25f, 0.25f,true,false},
		//{0.0f, 0.0f, 0.0f, 0.25f, 0.25f, 0.25f,true,false},
		//{-0.75f, 0.0f, 0.0f, 0.25f, 0.5f, 0.25f,true,false},
		//{-1.0f, 0.0f, 0.0f, 0.25f, 0.5f, 0.25f,true,false},
		//{-1.75f, 0.0f, 0.0f, 0.25f, 0.5f, 0.25f,true,false},
		//{-1.5f, 0.0f, 0.0f, 0.25f, 0.5f, 0.25f,true,false},
		//{-1.5f, 0.5f, 0.0f, 0.25f, 0.25f, 0.25f,true,false},

		//============stage3===================
		//{0.75f, 0.0f, 2.5f, 0.25f, 0.25f, 0.25f,true,false},
		//{-0.5f, 0.0f, 2.75f, 0.25f, 0.25f, 0.25f,true,false},
		//{-1.0f, 0.0f, 2.5f, 0.0f, 0.25f, 0.25f,true,false},
		//ポジション、スケール、憑依判定(trueで憑依)、
		//自動ムーブ判定(trueで自動、自動ブロックは否憑依(false)にして下さい[false,true])
		//=============stage4===================
		{1.5f, 0.0f, 2.0f, 0.24f, 0.25f, 0.25f,true,false},
		{0.75f, 0.0f, 2.0f, 0.24f, 0.25f, 0.25f,true,false},
		{1.0f, 1.25f, 2.0f, 0.24f, 0.25f, 0.25f,false,false},
		{0.0f, 0.0f, 2.0f, 0.24f, 0.5f, 0.25f,true,false},
	...
	Setting1 data1[] = {
		...
		//=======================stage4=========================
		{ 1.25f, 1.24f, 2.0f, 2.0f, 0.025f, 0.25f,1.5f,0.5f,0.0f},
		{ -1.25f, 1.25f, 2.0f, 1.5f, 0.025f, 0.25f,4.0f,1.5f,0.0f},
	...
	Setting3 data3[] = {
		...
		//==========stage2===================
		//{1.75f, 0.0f, 2.5f, 0.25f, 0.25f, 0.25f, false},
		//{0.0f, 0.25f, 2.5f, 0.25f, 0.25f, 0.25f, false},
		//{-0.25f, 0.0f, 2.5f, 0.25f, 0.25f, 0.25f, false},
		//{-1.0f, 0.5f, 2.5f, 0.25f, 0.25f, 0.25f, false},
		...
		//===============stage4===============
		{1.25f, 0.0f, 2.0f, -0.24f, 0.25f, -0.25f, true},//逆向き
		{1.0f, 0.0f, 2.0f, 0.24f, 0.25f, 0.25f, false},
		{0.25f, 0.0f, 2.0f, -0.24f, 0.25f, -0.25f, true},//逆向き
		{-0.25f, 0.0f, 2.75f, -0.24f, 0.25f,-0.25f, true},//逆向き
		{-1.5f, 0.0f, 2.0f, 0.24f, 0.25f, 0.25f, false},
	};
