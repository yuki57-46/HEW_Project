...
//	m_pModel->SetVertexShader(m_pVS);
	...
	m_anime_Levitation = m_pModel->AddAnimation("Assets/Animation/kuroko_huyuu.fbx");	//	ファイルパスを入れる
	if (FAILED(m_pModel->AddAnimation("Assets/Animation/kuroko_huyuu.fbx")))
	{
